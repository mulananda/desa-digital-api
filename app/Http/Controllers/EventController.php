...
class EventController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware(PermissionMiddleware::using(['event-list|event-create|event-edit|event-delete']), only:['index', 'getAllPaginnated', 'show']),
    ...
    public function destroy(string $id)
    {
        try{
            ...
            // jika id ditemukan delete datanya
