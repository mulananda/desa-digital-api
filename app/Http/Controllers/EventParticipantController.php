...
class EventParticipantController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware(PermissionMiddleware::using(['event-participant-list|event-participant-create|event-participant-edit|event-participant-delete']), only:['index', 'getAllPaginnated', 'show']),
    ...
    public function store(EventParticipantStoreRequest $request)
    {
        ...
        try{
            ...
            return ResponseHelper::jsonResponse(true, 'Data Pendaftar Event berhasil dibuat', new EventParticipantResource($eventParticipant), 201);
